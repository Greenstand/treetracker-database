...
DELETE FROM region WHERE type_id IN (
 SELECT id
 FROM region_type
 WHERE type IN ('grid-1000000m', 'grid-100000m', 'grid-10000m', 'grid-5000m')
);
DELETE FROM region_type WHERE type IN ('grid-1000000m', 'grid-100000m', 'grid-10000m', 'grid-5000m');
