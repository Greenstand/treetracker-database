...
exports.up = function(db, callback) {
  async.series(
    [
      ...
      db.runSql.bind(db, 'GRANT SELECT ON clusters TO treetracker'),
      ...
      db.runSql.bind(db, 'GRANT SELECT ON entity TO treetracker'),
      db.runSql.bind(db, 'GRANT SELECT ON entity_manager TO treetracker'),
